    ...
    <>
      <section className={`${styles.padding} bg-transparent relative z-10`}>
        <motion.div
          ...
          className={`${styles.innerWidth} mx-auto my-[200px] flex lg:flex-row flex-col gap-8 justify-center items-center`}>

          <div className={`flex-1 ${styles.flexCenter}`} id="Overview">
