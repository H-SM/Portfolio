...
import ResumeButton from "./ResumeButton2";
const Hero = () => {
  return (
    <>
        ...
        >
          ...
          >
            <motion.h1
              ...
              className={`${styles.heroTopperHeading} w-full flex justify-center items-center`}
            >
              HELLO, THIS IS
            </motion.h1>
            <motion.div
              variants={textVariant(1.2)}
              className="flex flex-col gap-12 justify-center items-center pt-8"
            >
              <img src={hsm} alt="gif" className="w-[356px] h-[200px]" />
              <ResumeButton className="pt-12"/>
