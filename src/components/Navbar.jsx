      ...
      >
        <div className={`${styles.innerWidth} mx-auto flex justify-between gap-8`}>
          ...
          <div className='relative transition ease-in-out duration-150 z-20'>
            <div className='w-[15rem] h-fit flex flex-col bordergradient rounded-[20px] bg-secondary-background py-2 px-4 justify-center items-center text-[2rem] transition ease-in-out duration-150 z-20'>
